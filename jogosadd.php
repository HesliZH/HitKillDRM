...
fjogosadd.validate = function() {
	...
	for (var i = startcnt; i <= rowcnt; i++) {
		...
		<?php } ?>
		<?php if ($jogos_add->responsavel->Required) { ?>
...
fjogosadd.lists["x_responsavel"] = <?php echo $jogos_add->responsavel->Lookup->toClientList() ?>;
fjogosadd.lists["x_responsavel"].options = <?php echo JsonEncode($jogos_add->responsavel->lookupOptions()) ?>;
...
<?php if ($jogos->responsavel->Visible) { // responsavel ?>
	<div id="r_responsavel" class="form-group row">
		<label id="elh_jogos_responsavel" for="x_responsavel" class="<?php echo $jogos_add->LeftColumnClass ?>"><?php echo $jogos->responsavel->caption() ?><?php echo ($jogos->responsavel->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $jogos_add->RightColumnClass ?>"><div<?php echo $jogos->responsavel->cellAttributes() ?>>
