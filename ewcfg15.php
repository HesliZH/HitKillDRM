...
define(PROJECT_NAMESPACE . "RANDOM_KEY", 'eTbqbky515oW5Xn0'); // Random key for encryption
...
$PROJECT_ID = "{D25E8543-1442-438F-944C-0B1439EAA2B1}"; // Project ID (GUID)
$RELATED_PROJECT_ID = "";
...
$NAVBAR_CLASS = "main-header navbar navbar-expand navbar-dark bg-info";
...
if (!defined(PROJECT_NAMESPACE . "USE_ADODB"))
	define(PROJECT_NAMESPACE . "USE_ADODB", TRUE); // Use ADOdb
if (!isset($GLOBALS["ADODB_OUTP"]))
	$GLOBALS["ADODB_OUTP"] = PROJECT_NAMESPACE . 'SetDebugMessage';

// Database connection info
$CONNECTIONS["DB"] = array("conn" => NULL, "id" => "DB", "type" => "POSTGRESQL", "host" => "35.188.12.175", "port" => 5432, "user" => "postgres", "pass" => "heslih123", "db" => "hitkillDRM", "schema" => "public", "qs" => "\"", "qe" => "\"");
...
define(PROJECT_NAMESPACE . "IS_MYSQL", FALSE); // MySQL
define(PROJECT_NAMESPACE . "IS_POSTGRESQL", TRUE); // PostgreSQL
...
define(PROJECT_NAMESPACE . "USER_TABLE_NAME", "usuarios");
define(PROJECT_NAMESPACE . "LOGIN_USERNAME_FIELD_NAME", "usuario");
define(PROJECT_NAMESPACE . "LOGIN_PASSWORD_FIELD_NAME", "senha");
...
define(PROJECT_NAMESPACE . "USER_TABLE", "\"usuarios\"");
define(PROJECT_NAMESPACE . "USER_NAME_FILTER", "(\"usuario\" = '%u')");
