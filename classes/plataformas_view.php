 ...
 * Page class
 */
class plataformas_view extends plataformas
{
	...
	// Page object name
	public $PageObjName = "plataformas_view";
	...
	public function run()
	{
		...
		if (!$validRequest) {
			...
			if (!$Security->canView()) {
				...
				if ($Security->canList())
					$this->terminate(GetUrl("plataformaslist.php"));
				else
		...
		if ($this->isPageRequest()) { // Validate request
			if (Get("codigo") !== NULL) {
				...
				$returnUrl = "plataformaslist.php"; // Return to list
			}
			...
			switch ($this->CurrentAction) {
				case "show": // Get a record to display
					...
					if (!$res) { // Load record based on key
						...
						$returnUrl = "plataformaslist.php"; // No matching record, return to list
					}
			}
		} else {
			$returnUrl = "plataformaslist.php"; // Not page request, return to list
		}
		if ($returnUrl <> "") {
	...
	protected function setupBreadcrumb()
	{
		...
		$Breadcrumb->add("list", $this->TableVar, $this->addMasterUrl("plataformaslist.php"), "", $this->TableVar, TRUE);
		$pageId = "view";
