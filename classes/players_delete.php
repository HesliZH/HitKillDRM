 ...
 * Page class
 */
class players_delete extends players
{
	...
	// Page object name
	public $PageObjName = "players_delete";
	...
	public function run()
	{
		...
		if ($filter == "") {
			$this->terminate("playerslist.php"); // Prevent SQL injection, return to list
			return;
		}
		...
		if ($this->isShow()) { // Load records for display
			...
			if ($this->TotalRecs <= 0) { // No record found, exit
				...
				$this->terminate("playerslist.php"); // Return to list
			}
		}
	}
