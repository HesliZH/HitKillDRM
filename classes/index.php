...
class index
{
	...
	public function run()
	{
		...
		if (!$Security->isLoggedIn())
			$Security->autoLogin();
		if ($Security->allowList(CurrentProjectID() . 'players'))
			$this->terminate("playerslist.php"); // Exit and go to default page
		if ($Security->allowList(CurrentProjectID() . 'licencas'))
			$this->terminate("licencaslist.php");
		if ($Security->allowList(CurrentProjectID() . 'cargos'))
			$this->terminate("cargoslist.php");
		if ($Security->allowList(CurrentProjectID() . 'plataformas'))
			$this->terminate("plataformaslist.php");
