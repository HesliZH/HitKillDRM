 ...
 * Page class
 */
class jogos_view extends jogos
{
	...
	public function run()
	{
		...
		if ($this->isPageRequest()) { // Validate request
			if (Get("codigo") !== NULL) {
				...
				$returnUrl = "jogoslist.php"; // Return to list
			}
			...
			switch ($this->CurrentAction) {
				case "show": // Get a record to display
					...
					if (!$res) { // Load record based on key
						...
						$returnUrl = "jogoslist.php"; // No matching record, return to list
					}
			}
		} else {
			$returnUrl = "jogoslist.php"; // Not page request, return to list
		}
		if ($returnUrl <> "") {
