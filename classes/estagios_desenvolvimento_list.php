 ...
 * Page class
 */
class estagios_desenvolvimento_list extends estagios_desenvolvimento
{
	...
	// Page object name
	public $PageObjName = "estagios_desenvolvimento_list";

	// Grid form hidden field names
	public $FormName = "festagios_desenvolvimentolist";
	...
	public function __construct()
	{
		...
		$this->AddUrl = "estagios_desenvolvimentoadd.php";
		$this->InlineAddUrl = $this->pageUrl() . "action=add";
		$this->GridAddUrl = $this->pageUrl() . "action=gridadd";
		$this->GridEditUrl = $this->pageUrl() . "action=gridedit";
		$this->MultiDeleteUrl = "estagios_desenvolvimentodelete.php";
		$this->MultiUpdateUrl = "estagios_desenvolvimentoupdate.php";
		...
		$this->FilterOptions->TagClassName = "ew-filter-option festagios_desenvolvimentolistsrch";
	...
	protected function processFilterList()
	{
		...
		if (Post("ajax") == "savefilters") { // Save filter request (Ajax)
			...
			$UserProfile->setSearchFilters(CurrentUserName(), "festagios_desenvolvimentolistsrch", $filters);
	...
	protected function setupOtherOptions()
	{
		...
		$item->Body = "<a class=\"ew-save-filter\" data-form=\"festagios_desenvolvimentolistsrch\" href=\"#\">" . $Language->phrase("SaveCurrentFilter") . "</a>";
		$item->Visible = TRUE;
		$item = &$this->FilterOptions->add("deletefilter");
		$item->Body = "<a class=\"ew-delete-filter\" data-form=\"festagios_desenvolvimentolistsrch\" href=\"#\">" . $Language->phrase("DeleteFilter") . "</a>";
		$item->Visible = TRUE;
		...
		$options = &$this->OtherOptions;
			...
			foreach ($this->ListActions->Items as $listaction) {
				if ($listaction->Select == ACTION_MULTIPLE) {
					...
					$item->Body = "<a class=\"ew-action ew-list-action\" title=\"" . HtmlEncode($caption) . "\" data-caption=\"" . HtmlEncode($caption) . "\" href=\"\" onclick=\"ew.submitAction(event,jQuery.extend({f:document.festagios_desenvolvimentolist}," . $listaction->toJson(TRUE) . "));return false;\">" . $icon . "</a>";
	...
	protected function setupSearchOptions()
	{
		...
		$item->Body = "<button type=\"button\" class=\"btn btn-default ew-search-toggle" . $searchToggleClass . "\" title=\"" . $Language->phrase("SearchPanel") . "\" data-caption=\"" . $Language->phrase("SearchPanel") . "\" data-toggle=\"button\" data-form=\"festagios_desenvolvimentolistsrch\">" . $Language->phrase("SearchLink") . "</button>";
		$item->Visible = TRUE;
