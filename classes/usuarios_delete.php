 ...
 * Page class
 */
class usuarios_delete extends usuarios
{
	...
	// Page object name
	public $PageObjName = "usuarios_delete";
	...
	public function run()
	{
		...
		if ($filter == "") {
			$this->terminate("usuarioslist.php"); // Prevent SQL injection, return to list
			return;
		}
		...
		if ($this->isShow()) { // Load records for display
			...
			if ($this->TotalRecs <= 0) { // No record found, exit
				...
				$this->terminate("usuarioslist.php"); // Return to list
			}
		}
	}
