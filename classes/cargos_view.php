 ...
 * Page class
 */
class cargos_view extends cargos
{
	...
	// Page object name
	public $PageObjName = "cargos_view";
	...
	public function run()
	{
		...
		if (!$validRequest) {
			...
			if (!$Security->canView()) {
				...
				if ($Security->canList())
					$this->terminate(GetUrl("cargoslist.php"));
				else
		...
		if ($this->isPageRequest()) { // Validate request
			if (Get("codigo") !== NULL) {
				...
				$returnUrl = "cargoslist.php"; // Return to list
			}
			...
			switch ($this->CurrentAction) {
				case "show": // Get a record to display
					...
					if (!$res) { // Load record based on key
						...
						$returnUrl = "cargoslist.php"; // No matching record, return to list
					}
			}
		} else {
			$returnUrl = "cargoslist.php"; // Not page request, return to list
		}
		if ($returnUrl <> "") {
	...
	protected function setupBreadcrumb()
	{
		...
		$Breadcrumb->add("list", $this->TableVar, $this->addMasterUrl("cargoslist.php"), "", $this->TableVar, TRUE);
		$pageId = "view";
