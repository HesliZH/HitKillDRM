 ...
 * Page class
 */
class players_add extends players
{
	...
	// Page object name
	public $PageObjName = "players_add";
		...
		switch ($this->CurrentAction) {
			...
			case "insert": // Add new record
				...
				if ($this->addRow($this->OldRecordset)) { // Add successful
					...
					elseif (GetPageName($returnUrl) == "playersview.php")
	...
	protected function addRow($rsold = NULL)
	{
		...
		// nome_completo
		$this->nome_completo->setDbValueDef($rsnew, $this->nome_completo->CurrentValue, NULL, FALSE);
