 ...
 * Page class
 */
class estagios_desenvolvimento_view extends estagios_desenvolvimento
{
	...
	// Page object name
	public $PageObjName = "estagios_desenvolvimento_view";
	...
	public function run()
	{
		...
		if ($this->isPageRequest()) { // Validate request
			if (Get("codigo") !== NULL) {
				...
				$returnUrl = "estagios_desenvolvimentolist.php"; // Return to list
			}
			...
			switch ($this->CurrentAction) {
				case "show": // Get a record to display
					...
					if (!$res) { // Load record based on key
						...
						$returnUrl = "estagios_desenvolvimentolist.php"; // No matching record, return to list
					}
			}
		} else {
			$returnUrl = "estagios_desenvolvimentolist.php"; // Not page request, return to list
		}
		if ($returnUrl <> "") {
