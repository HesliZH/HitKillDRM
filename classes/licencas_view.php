 ...
 * Page class
 */
class licencas_view extends licencas
{
	...
	// Page object name
	public $PageObjName = "licencas_view";
	...
	public function run()
	{
		...
		if ($this->isPageRequest()) { // Validate request
			if (Get("codigo") !== NULL) {
				...
				$returnUrl = "licencaslist.php"; // Return to list
			}
			...
			switch ($this->CurrentAction) {
				case "show": // Get a record to display
					...
					if (!$res) { // Load record based on key
						...
						$returnUrl = "licencaslist.php"; // No matching record, return to list
					}
			}
		} else {
			$returnUrl = "licencaslist.php"; // Not page request, return to list
		}
		if ($returnUrl <> "") {
