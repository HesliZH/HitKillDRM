 ...
 * Page class
 */
class players_view extends players
{
	...
	// Page object name
	public $PageObjName = "players_view";
	...
	public function run()
	{
		...
		if ($this->isPageRequest()) { // Validate request
			if (Get("codigo") !== NULL) {
				...
				$returnUrl = "playerslist.php"; // Return to list
			}
			...
			switch ($this->CurrentAction) {
				case "show": // Get a record to display
					...
					if (!$res) { // Load record based on key
						...
						$returnUrl = "playerslist.php"; // No matching record, return to list
					}
			}
		} else {
			$returnUrl = "playerslist.php"; // Not page request, return to list
		}
		if ($returnUrl <> "") {
