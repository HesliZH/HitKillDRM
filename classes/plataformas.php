...
/**
 * Table class for plataformas
 */
class plataformas extends DbTable
{
	protected $SqlFrom = "";
	protected $SqlSelect = "";
	...
	public function __construct()
	{
		...
		$this->TableVar = 'plataformas';
		$this->TableName = 'plataformas';
		$this->TableType = 'TABLE';

		// Update Table
		$this->UpdateTable = "\"plataformas\"";
		$this->Dbid = 'DB';
		$this->ExportAll = TRUE;
		...
		// codigo
		$this->codigo = new DbField('plataformas', 'plataformas', 'x_codigo', 'codigo', '"codigo"', 'CAST("codigo" AS varchar(255))', 3, -1, FALSE, '"codigo"', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'NO');
		...
		// descricao
		$this->descricao = new DbField('plataformas', 'plataformas', 'x_descricao', 'descricao', '"descricao"', '"descricao"', 200, -1, FALSE, '"descricao"', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
	...
	{
		return ($this->SqlFrom <> "") ? $this->SqlFrom : "\"plataformas\"";
	}
	...
	public function insert(&$rs)
	{
		...
		if ($success) {
			...
			$this->codigo->setDbValue($conn->getOne("SELECT currval('plataformas_codigo_seq'::regclass)"));
	...
	{
		global $Language;
		if ($pageName == "plataformasview.php")
			return $Language->phrase("View");
		elseif ($pageName == "plataformasedit.php")
			return $Language->phrase("Edit");
		elseif ($pageName == "plataformasadd.php")
	...
	{
		if ($parm <> "")
			$url = $this->keyUrl("plataformasview.php", $this->getUrlParm($parm));
		else
			$url = $this->keyUrl("plataformasview.php", $this->getUrlParm(TABLE_SHOW_DETAIL . "="));
	...
	{
		if ($parm <> "")
			$url = "plataformasadd.php?" . $this->getUrlParm($parm);
		else
			$url = "plataformasadd.php";
		return $this->addMasterUrl($url);
	}
	...
	{
		$url = $this->keyUrl("plataformasedit.php", $this->getUrlParm($parm));
		return $this->addMasterUrl($url);
	}
	...
	{
		$url = $this->keyUrl("plataformasadd.php", $this->getUrlParm($parm));
		return $this->addMasterUrl($url);
	}
	...
	{
		return $this->keyUrl("plataformasdelete.php", $this->getUrlParm());
	}
